 ...
 * @param <E>
 *            The type of the property element this {@link ExtractableProperties} represents.
 * @param <R>
 *            The type of the context reference.
 */
public interface ExtractableProperties<O, E, R> {

	/**
	 * Removes an element from the batch that is represented by this {@link ExtractableProperties}.
	 * <p>
	 ...
	 * 			If any property on the path to this {@link ExtractableProperties} is null.
	 * @throws UnreferencedPropertyPathException
	 *          If there is any uncontexted property in this {@link ExtractableProperties}'s path.
	 */
	 ...
	 * 			this {@link ExtractableProperties}; might be null.
	 * @return
	 * 			The element that has been removed; might be null if the element at the reference was null
	 * @throws InterruptedPropertyPathException
	 * 			If any property on the path to this {@link ExtractableProperties} is null.
	 * @throws UnreferencedPropertyPathException
	 * 			If there is any uncontexted property in this {@link ExtractableProperties}'s path that does not have a
	 ...
	 * 			elements this {@link ExtractableProperties} represents.
	 */
